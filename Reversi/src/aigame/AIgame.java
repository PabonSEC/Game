...
public class AIgame extends JFrame {
    ...
    static JLabel easy = new JLabel("Easy Level Selected");
    static JLabel hard = new JLabel("Hard Level Selected");
    ...
    static JButton easyLvl = new JButton("EASY");
    static JButton hardLvl = new JButton("HARD");
    //JComboBox<String> comb = new JComboBox<String>();
    static Icon pc = new ImageIcon("C:\\Users\\Shahnawaz Hossan\\Dropbox\\My Projects\\Game\\Reversi\\src\\AIPic\\pc.jpg");
    static Icon user = new ImageIcon("C:\\Users\\Shahnawaz Hossan\\Dropbox\\My Projects\\Game\\Reversi\\src\\AIPic\\user.jpg");
    ...
    AIgame() {
        ...
        easy.setBounds(315, 90, 160, 20);
        hard.setBounds(315, 90, 160, 20);
        txt.setBounds(370, 10, 100, 20);
        lbl1.setBounds(300, 10, 60, 20);
        lbl2.setBounds(300, 50, 60, 20);
        turn.setBounds(15, 2, 150, 40);
        think.setBounds(15, 2, 200, 40);
        btn3.setBounds(150, 170, 100, 30);
        txt1.setBounds(370, 50, 100, 20);
        credit.setBounds(260, 170, 100, 30);
        
        easyLvl.setBounds(375, 130, 100, 30);
        hardLvl.setBounds(375, 170, 100, 30);
        ...
        easyLvl.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
        ...
        hardLvl.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
