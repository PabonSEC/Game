...
public class PC {
    ...
    static int MxposX, MxposY, MnposX, MnposY;
    ...
    void work() {
        ...
        if (isItEasy == false) {
            ...
            ExtraThinkOfPc extra = new ExtraThinkOfPc();
        ...
        System.out.println("Best Move of PC is = " + i + ", " + j);
        ...
        if (enter == false && dhukse == true) {

            tag = true;

            AIgame.Play();

        } else if (enter == false && dhukse == false) {
